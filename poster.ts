...
if (options.verbose) {
  console.log(`Posting files in directory: \"${options.directory}\" matching: \"${options.regex}\"`);
  console.log(`Posting to: ${options.host}:${options.port}${options.path}`);
}
